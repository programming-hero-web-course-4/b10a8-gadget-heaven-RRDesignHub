      ...
      <div className="card bg-base-100 p-5">
        ...
        <div className="flex flex-col gap-y-3 mt-6">
          ...
          <div className="card-actions ">
            <Link to={`/${product_id}`}  className=" text-lg text-[#9b00c3] font-semibold bg-transparent border border-[#9b00c3] px-5 py-2 rounded-3xl hover:text-white hover:bg-[#9b00c3]">Buy Now</Link>
          </div>
        </div>
      </div>
    </>
