...
export default function SingleProductDetails() {
  ...
  return(
    <>
      <div className="relative mb-[800px] md:mb-[800px] lg:mb-[450px]">
        ...
        <div className="w-full max-sm:px-2 absolute left-1/2 -translate-x-1/2 -bottom-[730px] md:-bottom-[700px]  lg:-bottom-[365px] ">
            <div className='md:w-[600px]  lg:w-[1060px] lg:h-[550px] mx-auto border bg-white p-3 lg:p-6 rounded-3xl flex flex-col lg:flex-row gap-8'>
              <img className='max-sm:h-[300px] md:w-[550px] mx-auto lg:w-[420px] rounded-3xl bg-[#9c00c31a] p-5'  src={product_image} alt="" />
              <div className="">
                <h2 className="text-2xl font-bold text-dark-1">{product_title}</h2>
                <h3 className="text-xl font-medium text-[#09080fcb] my-4">Price: {price}k</h3>
                ...
                <div className="flex gap-4 items-center mt-4">
                  <button
                  onClick={()=>sharedAddToCardFunction("Add To Card",findProduct)} 
                  className="flex gap-2 items-center text-lg text-white font-semibold bg-[#9b00c3] border border-[#9b00c3] px-5 py-2 rounded-3xl hover:text-white hover:bg-[#9b00c3]"
